...
'''
def choose_product(driver):
    product = driver.find_element(by='xpath', value='//*[@id="wrapper"]/div[2]/div[1]/div/div[2]/div/div/div[2]/div/div[5]/div[2]/ul/li[1]/div/div[2]/h2/a')
    product.click()
def add_to_cart(driver):
    driver.implicitly_wait(15)
    # cart = driver.find_element(by='xpath',
    # value='//*[@id="product_addtocart_form"]/div/div[1]/div[2]/div[15]/div/ul/li[3]/button/span')
    # cart.click()
    cart = WebDriverWait(driver, 15).until(EC.element_to_be_clickable(
    (By.XPATH, '//*[@id="product_addtocart_form"]/div/div[1]/div[2]/div[15]/div/ul/li[3]/button/span')))
    cart.click()
def payment(driver):
    payment = driver.find_element(by='xpath', value='//*[@id="checkbox-product-419473"]')
    payment.click()
    name = driver.find_element(by='xpath', value='//*[@id="fhs_shipping_fullname"]')
    ...
    phone_number = driver.find_element(by='xpath', value='//*[@id="fhs_shipping_telephone"]')
    phone_number.send_keys(f'{phone}')
    city_province = driver.find_element(by='xpath', value='//*[@id="select2-fhs_shipping_city_select-container"]/span')
    city_province.click()
    input_city = driver.find_element(by='xpath', value='//*[@id="offcanvas-container"]/span/span/span[1]/input')
    input_city.send_keys(f'{city}')
    city_province.click()
    district = driver.find_element(by='xpath', value='//*[@id="select2-fhs_shipping_district_select-container"]')
    district.click()
    input_district = driver.find_element(by='xpath', value='//*[@id="offcanvas-container"]/span/span/span[1]/input')
    input_district.send_keys(f'{district_name}')
    district.click()
    ward = driver.find_element(by='xpath', value='//*[@id="fhs_shipping_street"]')
    ward.click()
    input_ward = driver.find_element(by='xpath', value='//*[@id="offcanvas-container"]/span/span/span[1]/input')
    input_ward.send_keys(f'{ward}')
    ward.click()
    adress = driver.find_element(by='xpath', value='//*[@id="fhs_shipping_street"]')
    adress.send_keys(f'{adress_name}')
#click to product
...
driver.quit()
#############  NOTICE  ##############
# This session is not suitable
# Need to operate oop
# Can not add to cart, may be they prevent sccaping bot ?
'''
